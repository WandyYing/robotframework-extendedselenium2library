...
ExtendedSeleniumLibrary is web testing library for `Robot Framework`_
...
It leverages SeleniumLibrary_ internally to provide AngularJS_ synchronization support,
to provide AngularJS_ locators support, to deliver keywords enhancement,
and strive for a seamless migration from SeleniumLibrary_.
...
.. code:: console
    ...
    pip install --upgrade robotframework-extendedSeleniumLibrary
    pip uninstall robotframework-extendedSeleniumLibrary
...
.. code:: console
    ...
    pip install robotframework-extendedSeleniumLibrary==x.x.x
...
- Download source distributions (``*.tar.gz``) for the library and its dependencies:
  ...
  - https://pypi.python.org/pypi/robotframework-extendedSeleniumLibrary
...
.. code:: console
    ...
    gpg --verify robotframework-extendedSeleniumLibrary-x.x.x.tar.gz.asc robotframework-extendedSeleniumLibrary-x.x.x.tar.gz
...
To write tests with Robot Framework and ExtendedSeleniumLibrary,
ExtendedSeleniumLibrary must be imported into your Robot test suite.
...
.. _SeleniumLibrary: https://goo.gl/1VXDSI
.. _Selenium 2 (WebDriver): http://goo.gl/boVQia
.. |Docs| image:: https://img.shields.io/badge/docs-latest-brightgreen.svg
    :target: https://goo.gl/9z5Xj9
    :alt: Keyword Documentation
.. |Version| image:: https://img.shields.io/pypi/v/robotframework-extendedSeleniumLibrary.svg
    :target: https://goo.gl/wHr4ni
    :alt: Package Version
.. |Status| image:: https://img.shields.io/pypi/status/robotframework-extendedSeleniumLibrary.svg
    :target: https://goo.gl/wHr4ni
    :alt: Development Status
.. |Python| image:: https://img.shields.io/pypi/pyversions/robotframework-extendedSeleniumLibrary.svg
    :target: https://goo.gl/sXzgao
    :alt: Python Version
.. |Download| image:: https://img.shields.io/pypi/dm/robotframework-extendedSeleniumLibrary.svg
    :target: https://goo.gl/wHr4ni
    :alt: Monthly Download
.. |License| image:: https://img.shields.io/pypi/l/robotframework-extendedSeleniumLibrary.svg
    :target: http://goo.gl/LOMJeU
    :alt: License
.. |Similarity| image:: https://raw.githubusercontent.com/rickypc/robotframework-extendedSeleniumLibrary/master/assets/RF-Cucumber-01.jpg
    :alt: Framework Similarities
.. |Onion| image:: https://raw.githubusercontent.com/rickypc/robotframework-extendedSeleniumLibrary/master/assets/RF-Cucumber-02.jpg
    :alt: Onion Diagram
.. |Actual| image:: https://raw.githubusercontent.com/rickypc/robotframework-extendedSeleniumLibrary/master/assets/RF-Cucumber-03.jpg
