...
from ExtendedSeleniumLibrary.locators.extendedelementfinder import ExtendedElementFinder


class ParseLocatorTests(unittest.TestCase):

    def setUp(self):
        self.finder = ExtendedElementFinder(None)
    ...
    def test_equal_sign_as_separator(self):
        ...
        self._verify_parse_locator('binding=foo', 'binding', 'foo')
